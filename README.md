...
- [[Java] 순환 참조를 방지하기 위한 의존성 역전 및 의존 관계 연결](https://github.com/tjdtls690/TIL/blob/main/Java/a_45_z_recur_ref_01.md)
- [[Java, Spring] Service Layer는 무엇이고 어떻게 활용해야 하는가?](https://bit.ly/3Ln03UA)
- [[Java, Spring] 단위 테스트의 재정립](https://bit.ly/3NNE8Hz)
- [[Java, Spring] 계층형 아키텍처 vs 헥사고날 아키텍처](https://bit.ly/43zYwAX)
- [[JDBC] 여러 조회를 한 번에 진행하기](https://bit.ly/3P4q6lA)
...
- [[MySQL, JPA] 페이징 성능 개선 여정 3편 - 동시성 처리 방식 개선](https://bit.ly/3VEv8ZB)
